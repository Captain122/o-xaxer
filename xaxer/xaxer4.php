...
<head>
    ...
    <meta name="keywords" content="onlayn igri,igri,gonka,arkada,tanki,friv xaxer" />
    <meta name="description" content="онлайн игры для всех,бесплатно и весело!!,friv,sport,racing,gonki,flash,html5 igri online-xaxer.xyz">
...
<div class="container">
    <div class="row">
        <?php require_once('../SIUD/select_xaxer24.php') ?>
        <?php foreach ($arajt as $post) {?>
            <div style="margin: 5px">
                <h5><?echo $post['name']?></h5>
                <div><a href="../game2.php/<?echo $post['sef']?>"><img src="<?echo $post['img']?>" style="width: 161px"></a></div>
            </div>
        <? } ?>
    </div>
</div>
