...
<head>
    ...
    <meta name="keywords" content="igri,online igri,gonka,tanki online,tanker,axjikneri hamar" />
...
<div class="container">
    <div class="row">
        <?php require_once('../SIUD/select_xaxer23.php') ?>
        <?php foreach ($arajt as $post) {?>
            <div style="margin: 5px">
                <h5><?echo $post['name']?></h5>
                <div><a href="../game2.php/<?echo $post['sef']?>"><img src="<?echo $post['img']?>" style="width: 181px"></a></div>
            </div>
        <? } ?>
    </div>
</div>
<div style="text-align: center">
    <a class="btn btn-info btn-lg" style="color:white;" href="/xaxer/xaxer4.php"><----     ՏԵՍՆԵԼ 3 ԷՋԻ ԽԱՂԵՐԸ     ----></br>sexmek myus eji xaxeri hamar</a></button>
</div>
