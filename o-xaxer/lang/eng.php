...
<head>
    ...
    <meta name="keywords" content="games, online games,auto,race,shooter,browser" />
    <meta name="description" content="best online games ,play free and only,shooting,arcade ,flash,html5 games in online-xaxer.xyz ">
    <link rel="shortcut icon" href="/img/xax.ico" type="image/x-icon">
    <title>online-xaxer.xyz online games portal</title>
...
<div class="submenu">
    <div class="submenu2">
        <h1>best online games for you!!!!</h1>
        <a class="btn btn-primary" style="color:white;" href="../pages/gonkaner.php">racing</a>
        <a class="btn btn-secondary" style="color:white;" href="../pages/zombiner.php">zombies</a>
        <a class="btn btn-success" style="color:white;" href="../pages/krakoci.php">shoot</a>
        <a class="btn btn-danger" style="color:white;" href="../pages/sexani.php">board</a>
        <a class="btn btn-warning" style="color:white;" href="../pages/arkadaner.php">arcade</a>
        <a class="btn btn-info" style="color:white;" href="../pages/sport.php">sport</a>
        <a class="btn btn-warning" style="color:white;" href="../pages/axjikneri.php">girls</a>
        <a class="btn btn-secondary" style="color:white;" href="../pages/casino.php">Casino</a>
        <a class="btn btn-success" style="color:white;" href="../pages/kriv.php">active</a>
