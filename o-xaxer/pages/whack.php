...
<head>
    ...
    <meta name="keywords" content="xaxer,online xaxer,gonka,krakoci,onlayn, օնլայն խաղեր" />
...
<div class="container">
    <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-2">
            <h1 style="text-align: center">sirayin xax</h1>
            <!-- Hey Webmaster! Place this html code where you'd like the game to appear. -->
            <iframe src="https://www.silvergames.com/en/whack-your-ex/iframe" width="720" height="480" style="margin:0;padding:0;border:0"></iframe>
